...
$LOAD_PATH << File.join(File.expand_path(File.dirname(__FILE__)), '../lib/java')

require 'java'
require 'worker/edit_button'
require 'worker/remote_server'
require 'worker/run_button'
require 'worker/html_button'
require 'worker/xml_button'
require 'miglayout'
